...
<body class="bg-gray-50">
  <header class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-main-color border-b text-sm py-2.5 sm:py-4 lg:pl-64 shadow-md">
    <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label="Global">
      ...
      <div class="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
        ...
        <div class="flex flex-row items-center justify-end gap-2">
         <div class="px-3 text-white text-base">
          <span class="font-bold">Welcome, </span>Username
         </div>
          <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
            <button id="hs-dropdown-with-header" type="button" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium bg-white align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-main-color focus:ring-offset-2 focus:ring-offset-white transition-all text-xs">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2" aria-labelledby="hs-dropdown-with-header">
              <div class="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg">
                ...
                <p class="text-sm font-medium text-gray-800 ">mahasiswa@student.ittelkom-sby.ac.id</p>
              </div>
              <div class="mt-2 py-2 first:pt-0 last:pb-0"> 
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm hover:bg-gray-200" href="#">
  ...
  <div class="sticky top-0 inset-x-0 z-20 bg-white shadow-md border-y px-4 sm:px-6 md:px-8 lg:hidden">
  ...
  <div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul class="space-y-1.5">
        <li>
          <a class="flex items-center font-semibold gap-x-3.5 py-2 px-2.5 dashboard-list-active text-base rounded-md" href="javascript:;">
            <iconify-icon icon="radix-icons:dashboard" class="text-xl"></iconify-icon>
            Dashboard
          </a>
        </li>
        <li>
          <a class="flex items-center font-semibold gap-x-3.5 py-2 px-2.5 text-base rounded-md hover:bg-main-color hover:text-white" href="javascript:;">
